...
public class Main {
    ...
    public static void topEconomicalBowlersIn2015() throws Exception {
        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/MyDatabase", "root", "H@rdt0remember");
        ...
        while (result.next()) {
            System.out.println("Bowler: " + result.getString("bowler") + ", Economy rate: " + result.getDouble("economy_rate"));
        }
        System.out.println("********************");
    }
